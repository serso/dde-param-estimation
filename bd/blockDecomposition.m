function [ L, D ] = blockDecomposition( A, n )
...
% for i = 1:n
%     if ( abs(A(i, i)) > 0 )
%         [elements, ~] = utils.addSparseElement(elements, i, i, i, 1);
%     else
%         [elements, ~] = utils.addSparseElement(elements, i, i, i, 0);
%     end
% end
% Lb = utils.createSparseMatrix(elements);
Lb = speye(n);
D1 = 2 * Lb;
