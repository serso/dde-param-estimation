...
function [t, x, xWithErrors, minTDist, maxTDist] = ddeParamEst_createInitialGrid (xSolH, N, tMin, tMax, xSigmaError, tSigmaError)
...
for i = 1: 1: N
    ...
    if ( isnan(x(i, 1)) )
        display(x(i, 1));
        throw (MException ('ArgumentCheck:IllegalArgument', 'X solution returned NaN!'));
    end
